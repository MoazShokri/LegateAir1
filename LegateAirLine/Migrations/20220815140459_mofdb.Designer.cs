...
namespace LegateAirLine.Migrations
{
    ...
    [Migration("20220815140459_mofdb")]
    partial class mofdb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegateAirLine.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LegateAirLine.Models.Bag", b =>
                {
                    ...
                    b.Property<int>("TravelerCode")
                        .HasColumnType("int");

                    b.HasKey("BagId");

                    b.HasIndex("TravelerCode");

                    b.ToTable("Bags");
                });

            modelBuilder.Entity("LegateAirLine.Models.TicketTrip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LegateAirLine.Models.ApplicationUser", null)
                        .WithMany()
